                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: (){
                                    Get.dialog(
                                      CustomDialogPop(title: "Clear Chat History?", message: "Are you sure you want to clear this conversation with SnapID Assistant?",isActionPopUp: true,svgPath: Assets.clearIcon,solidBtnLabel: "Clear Chat",solidBtnBg: AppColors.red, onCancel: (){
                                        Get.back();
                                      }, onPressed: (){

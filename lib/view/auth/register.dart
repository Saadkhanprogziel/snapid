                        ...
                        child: Form(
                          ...
                          child: Obx(() => Column(
                                children: [
                                  CustomTextField(
                                    onChanged: (value) {
                                      controller.register.value.firstName = value;
                                    },
                                  ...
                                  CustomTextField(
                                    onChanged: (value) {
                                      controller.register.value.lastName = value;
                                    },
                                  ...
                                  CustomTextField(
                                    onChanged: (value) {
                                      controller.register.value.email = value;
                                    },
                                  ...
                                  DropdownButtonFormField<String>(
                                    value: controller.register.value.gender,
                                    onChanged: (value) {
                                      controller.register.value.gender = value!;
                                    },
                                    validator: (value) {
                                      if (value == null || value.isEmpty) {
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: DropdownButtonFormField<String>(
                                          value:
                                              controller.register.value.countryCode,
                                          onChanged: (value) {
                                            controller.register.value.countryCode =
                                                value!;
                                          },
                                      ...
                                      Expanded(
                                        ...
                                        child: CustomTextField(
                                          onChanged: (value) {
                                            controller.register.value.phone = value;
                                          },
                                  ...
                                  CustomTextField(
                                    onChanged: (value) {
                                      controller.register.value.password = value;
                                    },
                                  ...
                                  CustomTextField(
                                    onChanged: (value) {
                                      controller.register.value.confirmPassword =
                                          value;
                                    },
